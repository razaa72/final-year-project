...
export default function NotFound() {
  return (
    <>
      <div className="container-fluid notfound d-flex justify-content-center align-items-center">
        <div className="container custom-bg-password text-center w-50">
          <div className="fs-1 fw-bold">Page Not Found</div>
          <p>
            Want some more pages?
            <br />
            contact me
          </p>
